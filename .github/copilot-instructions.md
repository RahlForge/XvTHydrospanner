# XvT Hydrospanner - Project Context

## Project Overview
This application is a mod manager for the LucasArts game "Star Wars - X-Wing vs TIE Fighter" and its expansion "Balance of Power".
...
- **Game Installation**: `C:\GOG Games\Star Wars-XVT`

## Initial Context
When starting a session, familiarize yourself with:
1. The project structure in this repository
